...
import pickle   #** saving/loading complex data structures
import os       #** used for file and directory handling
import time
import gym      #** provides a toolkit for developing and comparing RL algorithms
                ###  a 3rd party library called openAI Gym
import numpy as np
import torch
    ...
    for itr in range(params['n_iter']):
        ...
        if itr == 0:
            ...
            paths, envsteps_this_batch = utils.sample_trajectories(
                env, expert_policy, params['batch_size'], MAX_VIDEO_LEN, True)
        ...
        for _ in range(params['num_agent_train_steps_per_iter']):
          ...
          randomIN = np.random.permutation(len(replay_buffer.obs))[:params['train_batch_size']]
          ob_batch, ac_batch = replay_buffer.obs[randomIN], replay_buffer.acs[randomIN]
